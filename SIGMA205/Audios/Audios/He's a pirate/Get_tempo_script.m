...
[HP1 Fs] = audioread('He_s_a_pirate_Vane.wav');
HP1 = HP1(:,1);
[HP2 Fs] = audioread('He_s_a_pirate_Fan.wav');
HP2 = HP2(:,1);
[HP3 Fs] = audioread('He_s_a_pirate_Mariana.wav');
HP3 = HP3(:,1);
[HP4 Fs] = audioread('He_s_a_pirate_Lina.wav');
HP4 = HP4(:,1);
...
Tempo1 = tempo2(HP1,Fs);
if Tempo1(3) > 0.5
    Tempo1 = Tempo1(1);
else
    Tempo1 = Tempo1(2);
end
Tempo2 = tempo2(HP2,Fs);
if Tempo2(3) > 0.5
    Tempo2 = Tempo2(1);
else
    Tempo2 = Tempo2(2);
end
Tempo3 = tempo2(HP3,Fs);
if Tempo3(3) > 0.5
    Tempo3 = Tempo3(1);
else
    Tempo3 = Tempo3(2);
end
Tempo4 = tempo2(HP4,Fs);
if Tempo4(3) < 0.5
    Tempo4 = Tempo4(1);
else
    Tempo4 = Tempo4(2);
