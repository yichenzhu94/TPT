...
Ndata = 6e4;%3e3 the data length
Nexp = 20;%200 the number of Monte Carlo test

ker = 'rbf';
xi = 5/sqrt(2);
option = 0;
len1 = 2e4;%the first index of abrupted point
len2 = 4e4;%the second index of abrupted point
SNR = 15;
...
for n = 1 : Nexp
    ...
    mse_klms_csal1 = mse_klms_csal1 + e_klms_csal1.^2/Nexp;
...
hold off
legend('KRLS-CS','KLMS-CS','KLMS-CSL1','KLMS-CSAL1','location','Northwest');
title('(a)')
