%===============================================================================
% The Kernel Least Mean Square based on Coherence Sparsification and L1-norm 
% regularization (KLMS-CSL1) Algorithm
...
%
%
% function [err,tdict,ndict]=klms_csl1(v,d,mu,tresh,tresh_l1,ker,xi);
%
...
function [err,tdict,ndict,ndict_t] = klms_csl1(v,d,eta,tresh,tresh_l1,ker,xi)
...
function alphap = prox(eta,thresh,alpha)
    alphap = max(0,1 - thresh*eta./abs(alpha)).*alpha;
end
